  ...
  const fetchPokemonList = async (page, pageSize) => {
    try {
      const response = await axios.get(
        `http://localhost:8000/pokemon?page=${page}&pageSize=${pageSize}`
      );
  ...
  return (
    <div className="app-container">
      ...
      <div className="main">
        ...
        updatePokemon={updatePokemon} // Passa a função updatePokemon para o Modal
      />
        ...
        <div className="pagination-container-right">
          <div className="pagesize-selector-right">
            <label htmlFor="pagesize-select">
              Selecione o número de itens por página:{" "}
            </label>
            <select
              id="pagesize-select"
              value={pageSize}
        ...
        <div
          className={viewMode === "cards" ? "card-container" : "list-container"}
        >
        ...
        <div className="pagination-container">
          ...
          <div className="pagination-container">
            <div className="pagination-buttons">
              ...
              <button
                onClick={() => fetchPokemonList(currentPage - 1, pageSize)}
        ...
        <footer className="footer">powered by Gui</footer>
      </div>
    </div>
  );
}
